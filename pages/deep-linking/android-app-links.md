...
{
  "type": "tip",
  "title": "Using multiple fingerprints",
  "body": "You can insert both your debug and production fingerprints for testing. Simply separate them with a comma."
}
[/block]
...
[block:callout]
{
  ...
  "body": "If you use a [custom domain or subdomain for your Branch links](/dashboard/integrate/#change-link-domain), you should also add an entry for:"
}
[/block]
