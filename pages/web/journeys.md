...
[block:callout]
{
  "type": "info",
  "title": "Pro Tip",
  "body": "What this script does is move a lot of the Branch redirection logic to the Javascript on your own page, effectively 'clicking a Branch link' on page load."
}
[/block]
...
[block:callout]
{
  "type": "info",
  "title": "Pro Tip",
  "body": "[Click here](/dashboard/integrate/#use-applink-domain) to read about the value to use for `[branchsubdomain]`."
}
[/block]
