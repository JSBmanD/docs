...
![Selligent Message Studio](/images/pages/email/selligent/selligent.png)
...
![image](/images/pages/email/selligent/setup-config.png)

[block:callout]
{
  "type": "tip",
  "title": "Update Redirection logic",
  "body": "Don't forget to send a request to Selligent support to update the redirection logic - you'll want to send redirection URL as an HTTP location header instead of JavaScript redirection."
}
[/block]
...
[block:callout]
{
  ...
  "body": "If you need help with setting up a custom click-tracking domain - please ask your account manager or request support at Selligent."
}
[/block]
