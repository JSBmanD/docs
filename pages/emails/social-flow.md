...
[block:callout]
{
  ...
  "body": "If you need help with setting up a custom click-tracking domain - please ask your account manager or request support at Social Flow."
}
[/block]
...
![image](/images/pages/social-links/social-flow/setup-config.png)
