...
![Blueshift](/images/pages/email/blueshift/blueshift.png)
...
Navigate to the [Universal Email](https://dashboard.branch.io/email){:target="\_blank"} section of the Branch dashboard. Select <notranslate>**Blueshift**</notranslate> and click <notranslate>**Enable**</notranslate>.
...
![image](/images/pages/email/blueshift/setup-config.png)
...
[block:callout]
{
  ...
  "body": "If you need help with setting up a custom click-tracking domain - please ask your account manager or request support at Blueshift."
}
[/block]
