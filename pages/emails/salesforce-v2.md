...
![image](/images/pages/email/salesforce_dns/setup-config.png)
...
1. Configure the Sender Authentication Package for your Salesforce Marketing Cloud account using instructions form your Salesforce account manger.
    ...
    ![image](/images/pages/email/salesforce_dns/create-domain.png)
...
[block:callout]
{
  ...
  "body": "As soon as you've configured and verified the Sender Authentication Package with the Salesforce team, please find the <notranslate>**click**</notranslate> record in your DNS settings so we can update your DNS settings."
}
[/block]
