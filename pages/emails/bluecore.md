...
Navigate to the [Universal Email](https://dashboard.branch.io/email){:target="\_blank"} section of the Branch dashboard. Select <notranslate>**BlueCore**</notranslate> and click <notranslate>**Enable**</notranslate>.
...
[block:callout]
{
  ...
  "body": "This domain must be validated in BlueCore, before you can enable the Branch integration.  For more information on how to validate a new domain in BlueCore, please contact your BlueCore account manager."
}
[/block]
