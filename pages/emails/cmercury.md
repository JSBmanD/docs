...
![image](/images/pages/email/icubes_pro/cmercury-setup.png)
...
1. Add and verify a custom click tracking domain in the <notranslate>**[Acount Settings](https://app.icubespro.com/Masters/AccountSettings){:target="\_blank"}**</notranslate> section of your Cmercury account:
    ...
    ![image](/images/pages/email/icubes_pro/create-domain.png)
...
[block:callout]
{
  ...
  "body": "If you need help with setting up a custom click-tracking domain - please ask your account manager or request support at Cmercury."
}
[/block]
