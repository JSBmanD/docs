...
![image](/images/pages/deep-linking/universal-links/how_branch_improves.png)
...
![image](/images/pages/deep-linking/universal-links/dashboard_enable_universal_links.png)

### XCode에서 Associated Domains 를 활성화

1. 프로젝트 파일에서 `Capabilities` 탭으로 이동합니다.
1. 마우스 스크롤 다운하여 `Associated Domains` 를 활성화 합니다. ![image](/images/pages/deep-linking/universal-links/enable_ass_domains.png)

[block:callout]
{
  "type": "tip",
  "title": "If you see an error after this step",
  "body": "![image](/images/pages/deep-linking/universal-links/enable_ass_domains_error.png)"
}
[/block]
...
1. 도메인을 복사합니다.![image](/images/pages/deep-linking/universal-links/subdomain-setting.png)
...
![image](/images/pages/deep-linking/universal-links/add_domain.png)
...
1. 커스텀 도메인을 하나의 String 으로 추가합니다. ![image](/images/pages/deep-linking/universal-links/branch-universal-link-domain.png)
1. 저장합니다.
